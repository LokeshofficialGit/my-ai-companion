...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        /* Fixed Mobile Screen Aspect Ratio Frame */
        body { 
            background: #000000; 
            color: #f4f4f5; 
            display: flex; 
        ...
        .app-wrapper {
            width: 100%;
            max-width: 440px; /* Smartphone Frame Width */
            height: 100vh;
            max-height: 920px;
            background: #09090b;
            display: flex;
        ...
        .toggle-sidebar-btn { background: transparent; border: none; color: #a1a1aa; font-size: 1.2rem; cursor: pointer; padding: 6px; }
        ...
        .placeholder-screen i { font-size: 2.5rem; margin-bottom: 12px; color: #3f3f46; }

        /* Chat View Area & Scrollability Fix */
        ...
        .message .content { background: #121215; border: 1px solid #27272a; padding: 10px 14px; border-radius: 14px; font-size: 0.9rem; line-height: 1.45; color: #e4e4e7; word-break: break-word; }
        .message.user .content { background: #9333ea; border: none; color: white; border-bottom-right-radius: 2px; }
        .message.ai .content { border-bottom-left-radius: 2px; }
        .message .sender-name { font-size: 0.7rem; color: #71717a; margin-bottom: 3px; font-weight: 600; }
        
        .action-text { color: #c084fc; font-style: italic; }

        /* Typing Dots */
        .typing-dots { display: flex; gap: 4px; align-items: center; padding: 4px 0; }
        .typing-dots span { width: 5px; height: 5px; background: #a1a1aa; border-radius: 50%; animation: pulse 1.2s infinite ease-in-out; }
        .typing-dots span:nth-child(2) { animation-delay: 0.2s; }
        .typing-dots span:nth-child(3) { animation-delay: 0.4s; }
        @keyframes pulse { 0%, 100% { opacity: 0.3; transform: scale(0.8); } 50% { opacity: 1; transform: scale(1.1); } }

        /* Bottom Fixed Input Bar */
        .input-area { padding: 12px 16px; border-top: 1px solid #1c1c21; background: #121215; display: flex; gap: 10px; width: 100%; box-sizing: border-box; }
        .input-area input { flex: 1; background: #09090b; border: 1px solid #27272a; padding: 10px 14px; border-radius: 10px; color: white; outline: none; font-size: 0.9rem; }
        .input-area button { padding: 10px 16px; background: #9333ea; color: white; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; }

        /* Scrollable Forms Fix */
        .form-container { padding: 20px; overflow-y: auto; flex: 1; width: 100%; -webkit-overflow-scrolling: touch; }
        .form-group { margin-bottom: 16px; }
        .form-group label { display: block; margin-bottom: 6px; font-size: 0.8rem; color: #a1a1aa; font-weight: 600; }
        .form-group input, .form-group textarea { width: 100%; background: #121215; border: 1px solid #27272a; padding: 10px; border-radius: 10px; color: white; outline: none; font-size: 0.88rem; }
        .form-group textarea { height: 80px; resize: vertical; }

        .hidden { display: none !important; }
        .avatar-preview { width: 70px; height: 70px; border-radius: 50%; object-fit: cover; margin-top: 8px; background: #27272a; border: 2px solid #3f3f46; }
    </style>
</head>
<body>
    ...
    <div class="app-wrapper">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="nav-section">
                ...
                <div class="section-title" style="margin-top: 12px;">Group Chats</div>
        ...
        <div class="main-content">
            <div class="top-bar">
                ...
                <div id="top-actions" class="hidden" style="display: flex; gap: 6px;">
                    ...
                    <button class="icon-btn" onclick="clearCurrentChat()" title="Clear History"><i class="fa-solid fa-trash"></i></button>
                </div>
            </div>
            ...
            <div id="placeholder-view" class="placeholder-screen">
                ...
                <p style="font-size: 0.8rem; margin-top: 4px;">Choose a character to start chatting!</p>
            </div>
            ...
            <div id="char-form" class="form-container hidden">
                <h3 style="margin-bottom: 18px; font-weight: 700;" id="char-form-title">Create Companion</h3>
            ...
            <div id="group-form" class="form-container hidden">
                <h3 style="margin-bottom: 18px; font-weight: 700;">Create Group Chat</h3>
                <div class="form-group">
            ...
            <div id="settings-form" class="form-container hidden">
                <h3 style="margin-bottom: 18px;">Backup & Restore Data</h3>
                <div class="form-group">
                    <label>Export Companion Data</label>
                    <button class="create-btn" style="margin:0; width:100%;" onclick="exportData()"><i class="fa-solid fa-download"></i> Export Companions & Chats (.json)</button>
                </div>
    ...
    <script>
        ...
        function renderGroupSelector() {
            ...
            container.innerHTML = characters.map(c => `
                <label style="display:flex; align-items:center; gap:8px; background:#121215; padding:8px; border-radius:8px;">
